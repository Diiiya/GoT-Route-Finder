...
class DijkstraGraphClassTest {
	...
	void beforeEach() {
		...
		nodesList.get(0).addTwoWayNeighbour(nodesList.get(1), 1, 1, 0);
		nodesList.get(0).addTwoWayNeighbour(nodesList.get(2), 1, 3, 0);
		nodesList.get(0).addTwoWayNeighbour(nodesList.get(3), 2, 3, 0);

		nodesList.get(1).addTwoWayNeighbour(nodesList.get(2), 2, 1, 0);
		nodesList.get(1).addTwoWayNeighbour(nodesList.get(3), 3, 3, 0);

		nodesList.get(2).addTwoWayNeighbour(nodesList.get(4), 2, 1, 0);

		nodesList.get(3).addTwoWayNeighbour(nodesList.get(4), 7, 3, 0);
